...
public class Db2TestResource {
    ...
    public void start() {
        ...
        System.setProperty("DB2_HOSTNAME", container.getHost());
        System.setProperty("DB2_PORT", container.getMappedPort(DB2_PORT).toString());
        System.setProperty("DB2_DATABASE", DATABASE);
    }
